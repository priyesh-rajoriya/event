...
import { Container, Header, Content, Footer, FooterTab, Icon, Card, Tab, Tabs, Badge } from 'native-base';
...
export default class NotificationDetail extends Component {
    ...
    alert() {
        Alert.alert('Alert Title', 'Aelect an Event or Ongoing Volunteey Opportunity', [
            {
                text: 'Special Event',
                onPress: () => console.log('Special Event pressed')
            }, {
                text: 'CANCEL',
                        ...
                        <View style={{ width: width, flexDirection: "row", alignItems: 'center', justifyContent: 'center', }}>
                            ...
                            <TouchableOpacity
                                ...
                                <Image
                                    ...
                                    source={require('../Images/icons8-upload-100.png')} />
                            </TouchableOpacity>
                        </View>
                    </Header>
                </LinearGradient>
                <View style={{ marginTop: 20, }}>
                    <Image style={{ width: '90%', height:170, alignSelf: 'center' }}
                        source={{ uri: params.image_url }} />

                </View>
                <TouchableOpacity>
                    <Text style={{ fontWeight: 'bold', color: '#58ACFA', fontSize: 24,alignSelf: 'center',marginTop:30 }}>More Details
                         </Text>
                </TouchableOpacity>
                <Text style={{fontSize:20, color:'#000', marginTop:10, alignSelf:'center'}}>{params.title}
                </Text>
                <Text style={{ color: '#6E6E6E', fontSize: 18, marginTop: 5, alignSelf: 'center' }}>{params.vanue}
                </Text>
                <Text style={{ color: '#6E6E6E', fontSize: 18, marginTop: 5, alignSelf: 'center' }}>{params.start_date}  {params.start_month}, {params.start_day}, {params.from_time}-{params.to_time}
                </Text>
