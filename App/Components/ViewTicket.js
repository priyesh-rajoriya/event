...
var itemHeight = height + 1000
import { Calendar } from 'react-native-calendars';
import Carousel from 'react-native-snap-carousel';
import Share, { ShareSheet, Button } from 'react-native-share';
import { DrawerNavigator, StackNavigator, NavigationActions, navigation } from "react-navigation";
...
export default class ViewTicket extends Component {
  ...
  alert() {
    Alert.alert('Alert Title', 'Select an Event or Ongoing Volunteey Opportunity', [
      {
        text: 'Special Event',
  ...
  getTickets() {
    ...
    // tempTicket=[params.ticket];
    var qnt = params.ticket.quantity;
    console.log(qnt, 'qnttttttttt')
    if (qnt > 1) {
    ...
    console.log(tempTicket, 'hhgfhgfhgb')
  }
  backgo() {
    tempTicket = []
  ...
  render() {
    var params = this.props.navigation.state.params
    console.log('123hello', params.ticket)
    return (
        ...
        <View
          ...
          <TouchableOpacity onPress={() => this.backgo()}>
            <Image
              ...
              source={require('../Images/crossicon_white.png')} />
          </TouchableOpacity>
        </View>
        {params != undefined &&
          <Carousel
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                  <View
                    ...
                    <Image
                      ...
                      source={{ uri: item.ticket_qr_code }} />
                    <Text
                      style={{
                        fontSize: 16,
                        marginTop: 20,
                        ...
                        width: '100%',
                        textAlign: "center"
                      }}>----------- Ticket {index} of {item.quantity}  -----------</Text>
                    <Text
                      style={{
                        marginTop: 20,
                        marginLeft: 10,
                      ...
                      <View
                        ...
                        <Text
                          style={{
                            ...
                            marginLeft: 10,
                            marginTop: 5
                          }}>{item.start_day},{item.start_month} {item.start_date},{item.from_time}-{'\n'}{item.to_time}GMT+05:30</Text>
                        <TouchableOpacity>
                          <Text
                            style={{
                              marginTop: 5,
                 ...
                 <Calendar
                   ...
                   markedDates={{[this.state.selected]: {selected: true, disableTouchEvent: true, selectedDotColor: 'orange'}}}
                    ...
                    <Text
                      ...
                      <TouchableOpacity>
                      <Text style={{ fontSize: 17, marginLeft: 5, marginTop: 5, color: '#81BEF7' }}>{item.organizer_name}
                      </Text>
                    </TouchableOpacity>
                  </View>
                </ScrollView>
