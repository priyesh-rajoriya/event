...
import {
  ...
  View, Image, TextInput, TouchableOpacity, ImageBackground, ScrollView, backgroundColor,BackHandler
} from 'react-native';
...
export default class NonProfitEventDetails extends Component {
  constructor(props) {
    super(props);
    this.state = {
      text: '',
...
this.props.navigation.navigate(
  ...
  BecomeaMemberform() {
    this.props.navigation.navigate('BecomeaMemberform');
    console.log('done');
  };
  Events(){
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Header hasTabs
          style={{ backgroundColor: "transparent", justifyContent: 'center',marginTop:20 }}
          ...
          <View style={{ width: width, flexDirection: "row", }}>
            <TouchableOpacity  onPress={() => this.props.navigation.goBack()}
              ...
              <Image source={require('../Images/Icons/keyboard-backspace.png')}
                style={{ width: 35, height: 40, tintColor: '#000' }} />
            </TouchableOpacity>
        ...
        <Image style={{ height: 170, width:'100%', marginTop: 10,}}
          ...
          <Text style={{ fontSize: 28, marginTop: 25, marginLeft: 20 }}>{params.title}</Text>
         <View style={{flexDirection:'row',marginTop:20,}}>
          <TouchableOpacity  onPress={() => this.BecomeaMemberform()}>
                <LinearGradient colors={['#F1948A', '#E59866',]} style={{justifyContent:'center', padding: 5, height: 45, width:200,marginLeft:20 }}>
         ...
         <TouchableOpacity>
         <Image style={{ height: 40, width: 40,marginLeft:40, }}
         source={require('../Images/if_SocialMedia_Website_2959724.png')} />
         </TouchableOpacity>
         </View>
        ...
        <TouchableOpacity>
           ...
           <View style={{ flexDirection: 'row', marginTop: 40, marginLeft: 30 }}>
            ...
            <View style={{ marginLeft: 10 }}>
              <Text style={{ fontSize: 18 }}>{params.start_day}, {params.end_day} {params.end_date}</Text>
          ...
          <View style={{ flexDirection: 'row', marginTop: 30, marginLeft: 30 }}>
            ...
            <View style={{ marginLeft: 10 }}>
              <Text style={{ fontSize: 18 }}>{params.vanue}</Text>
            </View>
          </View>
          ...
          <View style={{ flexDirection: 'row', marginTop: 30, marginLeft: 30 }}>
            ...
            <View style={{ marginLeft: 10 }}>
              <Text style={{ fontSize: 18 }}>Membership Fees</Text>
              <Text style={{ fontSize: 16, color: '#A4A4A4' }}>20$</Text>
            </View>
          </View>
          ...
          <View style={{ flexDirection: 'row', marginTop: 30, marginLeft: 30 }}>
            ...
            <View style={{ marginLeft: 10 }}>
              <Text style={{ fontSize: 18 }}>Total Member</Text>
              <Text style={{ fontSize: 16, color: '#A4A4A4' }}>{params.members}</Text>
            </View>
          </View>
          ...
          <Text style={{ fontSize: 20, marginTop: 10, marginLeft: 20 }}>{params.vanue}</Text>
          ...
          <TouchableOpacity>
          <Text style={{ fontSize: 20, marginTop: 20, marginLeft: 20 }}>More NPO like this</Text>
          </TouchableOpacity>
        ...
        <FlatList
          ...
          <TouchableOpacity onPress={() => this.openList1(item)}>
           <Card style={{height:200, width:300, marginLeft:10, marginRight:10}}>  
           <Image
                style={{
                height: 110,
                width:'100%' }}
